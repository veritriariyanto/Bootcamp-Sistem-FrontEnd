      ...
      <div class="grid gap-8 p-8 text-x-black mt-10">
        ...
        <div class="flex flex-col md:flex-row overflow-hidden">
          ...
          <img
            ...
            alt="Blog image"
            class="w-full md:w-1/2 h-60 object-cover"
          />
          <!-- Text Content -->
          <div class="p-6 md:w-1/2 text-gray-300">
        ...
        <div class="flex flex-col md:flex-row overflow-hidden">
          <!-- Image -->
          <img
            src="\src\assets\images\Blog\allpost\img2.png"
            alt="Blog image"
            class="w-full md:w-1/2 h-60 object-cover"
          />
          <!-- Text Content -->
        ...
        <div class="flex flex-col md:flex-row overflow-hidden">
          <!-- Image -->
          <img
            src="\src\assets\images\Blog\allpost\img3.png"
            alt="Blog image"
            class="w-full md:w-1/2 h-60 object-cover"
          />
          <!-- Text Content -->
        ...
        <div class="flex flex-col md:flex-row overflow-hidden">
          <!-- Image -->
          <img
            src="\src\assets\images\Blog\allpost\img4.png"
            alt="Blog image"
            class="w-full md:w-1/2 h-60 object-cover"
          />
          <!-- Text Content -->
