  ...
  <div id="Category">
    <div class="container mx-auto mt-10 text-x-black">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="card p-4">
          <div
            class="card-body w-full h-56 hover:bg-x-blue hover:text-x-light shadow-lg rounded-none"
          >
            <div class="mb-2">
              <img
        ...
        <div class="card p-4">
          ...
          >
            <div class="mb-2">
              <img
                src="/src/assets/images/Home/Icon/icon3.png"
                alt="icon"
                class="w-12 h-12 bg-x-light rounded"
              />
            </div>
        ...
        <div class="card p-4">
          ...
          >
            <div class="mb-2">
              <img
                src="/src/assets/images/Home/Icon/icon4.png"
                alt="icon"
                class="w-12 h-12 bg-x-light rounded"
              />
            </div>
